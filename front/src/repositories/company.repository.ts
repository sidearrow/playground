...
export class CompanyRepository extends AbstractRepository {
  ...
  public static async findByCompanyCode(companyCode: string): Promise<CompanyEntity> {
    return (await CompanyRepository.axiosInstance.get(`/company/${companyCode}`)).data;
  }
}
