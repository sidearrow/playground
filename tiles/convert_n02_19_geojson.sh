...
tippecanoe -B 10  -z${MAX_ZOOM_LEVEL_RS} -Z${MIN_ZOOM_LEVEL_RS} -o ${MBTILES_FILE_RS} ${IN_RS} -l ${LAYER_NAME_RS} --force
tippecanoe -B 10  -z${MAX_ZOOM_LEVEL_S} -Z${MIN_ZOOM_LEVEL_S} -o ${MBTILES_FILE_S} ${IN_S} -l ${LAYER_NAME_S} --force
